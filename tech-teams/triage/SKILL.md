---
name: cr-debug-info-triage
description: Apply Triage-team debug-info requirements to CRs routed by the core_crtriage_tool script.
---

# Triage CR Debug Info Review

Use when `core_crtriage_tool` routes a CR to Triage.

Read `README.md` in this folder for the current Triage criteria. If the README
...
and set `criteriaSource` to `tech-teams/triage/README.md (blank criteria)`.
...
```json
{
  ...
  "criteriaSource": "tech-teams/triage/README.md",

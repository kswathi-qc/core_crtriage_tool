---
name: cr-debug-info-security
description: Apply Security-team debug-info requirements to CRs routed by the core_crtriage_tool script.
---

# Security CR Debug Info Review

Use when `core_crtriage_tool` routes a CR to Security.

Read `README.md` in this folder for the current Security criteria. If the README
...
and set `criteriaSource` to `tech-teams/security/README.md (blank criteria)`.
...
```json
{
  ...
  "criteriaSource": "tech-teams/security/README.md",

---
name: cr-debug-info-openwrt
description: Apply OpenWRT-team debug-info requirements to CRs routed by the core_crtriage_tool script.
---

# OpenWRT CR Debug Info Review

Use when `core_crtriage_tool` routes a CR to OpenWRT.

Read `README.md` in this folder for the current OpenWRT criteria. If the README
...
and set `criteriaSource` to `tech-teams/openwrt/README.md (blank criteria)`.
...
```json
{
  ...
  "criteriaSource": "tech-teams/openwrt/README.md",

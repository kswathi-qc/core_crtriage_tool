---
name: cr-debug-info-kernel
description: Apply Kernel-team debug-info requirements to CRs routed by the core_crtriage_tool script.
---

# Kernel CR Debug Info Review

Use when `core_crtriage_tool` routes a CR to Kernel.

Read `README.md` in this folder for the current Kernel criteria. If the README
...
and set `criteriaSource` to `tech-teams/kernel/README.md (blank criteria)`.

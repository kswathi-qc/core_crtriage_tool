---
name: cr-debug-info-u-boot
description: Apply U-Boot-team debug-info requirements to CRs routed by the core_crtriage_tool script.
---

# U-Boot CR Debug Info Review

Use when `core_crtriage_tool` routes a CR to U-Boot.

Read `README.md` in this folder for the current U-Boot criteria. If the README
...
and set `criteriaSource` to `tech-teams/u-boot/README.md (blank criteria)`.
...
```json
{
  ...
  "criteriaSource": "tech-teams/u-boot/README.md",
